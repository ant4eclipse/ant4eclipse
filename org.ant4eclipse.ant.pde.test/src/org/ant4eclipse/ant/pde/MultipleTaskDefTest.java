...
public class MultipleTaskDefTest extends AbstractPdeBuildFileTest {
  ...
  public void testAntCall() {
    ...
    pdeProjectBuilder.withBundleManifest().withBundleVersion( "1.0.0" )
        .withFragmentHost( "org.eclipse.osgi;bundle-version=\"[3.2.0,4.0.0)\"" )
        .withImportPackage( "org.eclipse.ant.core" );
