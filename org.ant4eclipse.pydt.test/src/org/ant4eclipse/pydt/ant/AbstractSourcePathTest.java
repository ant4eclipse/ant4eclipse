...
public class AbstractSourcePathTest extends AbstractWorkspaceBasedTest {
  ...
  public void complexProject() {
    final String projectname = createComplexProject(_sourcepathxml, false, false).getFirst();
    final BuildResult buildresult = execute(projectname, "get-source-path");
    final String[] content = buildresult.getTargetOutput("get-source-path");
    Assert.assertEquals(1, content.length);
    Assert.assertEquals("${workspacedir}" + File.separator + projectname, content[0]);
  ...
  public void complexProjectMultipleFoldersFailure() {
    final String projectname = createComplexProject(_sourcepathxml, true, false).getFirst();
    execute(projectname, "get-source-path");
  }

  @Test(expected = BuildException.class)
  public void complexProjectMultipleFoldersBothFailure() {
    final String projectname = createComplexProject(_sourcepathxml, true, true).getFirst();
    execute(projectname, "get-source-path");
  }
  ...
  public void cyclicProject() {
    final String projectname = createCyclicProject(_sourcepathxml, false, false).getFirst();
    final BuildResult buildresult = execute(projectname, "get-source-path");
    final String[] content = buildresult.getTargetOutput("get-source-path");
    Assert.assertEquals(1, content.length);
    Assert.assertEquals("${workspacedir}" + File.separator + projectname, content[0]);
  ...
  public void cyclicProjectMultipleFoldersFailure() {
    final String projectname = createCyclicProject(_sourcepathxml, true, false).getFirst();
    execute(projectname, "get-source-path");
  }

  @Test(expected = BuildException.class)
  public void cyclicProjectMultipleFoldersBothFailure() {
    final String projectname = createCyclicProject(_sourcepathxml, true, true).getFirst();
    execute(projectname, "get-source-path");
  }
