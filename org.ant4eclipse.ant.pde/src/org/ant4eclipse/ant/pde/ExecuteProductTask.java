...
public class ExecuteProductTask extends AbstractExecuteProjectTask implements PdeExecutorValues,
   ...
   *          The TargetPlatform used to resolve the bundles against. Not <code>null</code>.
   */
  private void contributeForAll( MacroExecutionValues values, ProductDefinition productdef,
      TargetPlatform targetplatform ) {
    ...
    String launcherFragmentName = String.format( FRAGMENT_ORG_ECLIPSE_EQUINOX_LAUNCHER,
        configuration.getWindowingSystem(), configuration.getOperatingSystem(), configuration.getArchitecture() );
