...
public class MacroExecutionDelegate extends AbstractAntDelegate {
  ...
  public void executeMacroInstance(final MacroDef macroDef, final String prefix,
      final Map<String, String> scopedProperties, final Map<String, Object> scopedReferences) {
    ...
    antPropertiesRaper.setScopedValues(scopedProperties, prefix);
    antReferencesRaper.setScopedValues(scopedReferences, prefix);
