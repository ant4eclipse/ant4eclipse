...
import org.ant4eclipse.model.platform.resource.workspaceregistry.DefaultEclipseWorkspaceDefinition;
...
public class WorkspaceDelegate extends AbstractAntDelegate {
  ...
  /**
   * Prepares this basical workspace related functionality for the supplied ant component.
   * 
   * @param component
