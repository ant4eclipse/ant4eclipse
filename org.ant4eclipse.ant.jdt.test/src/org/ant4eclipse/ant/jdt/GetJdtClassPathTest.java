...
public class GetJdtClassPathTest extends AbstractJdtClassPathTest {
  ...
  public void testSimple_TwoClassFolders() throws Exception {
    File projectcDir = JdtProjectBuilder.getPreConfiguredJdtBuilder( "projectc" )
        .withSrcClasspathEntry( "gen-src", "gen-classes", false ).createIn( getTestWorkspaceDirectory() );
  ...
  public void test_WithMultipleReferences() throws Exception {
    ...
    File projectcDir = JdtProjectBuilder.getPreConfiguredJdtBuilder( "projectc" )
        .withSrcClasspathEntry( "/projectb", false ).createIn( getTestWorkspaceDirectory() );
